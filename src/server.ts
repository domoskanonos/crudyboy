...
import { OpenApiGenerator } from "./openapi/open-api-gen";
...
export class CrudyboyServer {
  ...
  async init(): Promise<void> {
    ...
    let propertiesByCollection: Map<string, any> =
      await this.client.getPropertiesByCollection();
  ...
  private async generateOpenApiDoc(propertiesByCollection: Map<string, any>) {
    ...
    const openApiDocPath = openApiGenerator.generateOpenApiDocPath(
      propertiesByCollection
    );
